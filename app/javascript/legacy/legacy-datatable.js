...
(function () {
  ...
  function initDatatables() {
    ...
    $("#usuariostable").DataTable({
      ...
      serverSide: false, // 👈 👈 👈 Esto es FUNDAMENTAL
      ...
      columns: [
        ...
        { data: "fecha_baja", defaultContent: "" },
        { data: null, orderable: false, searchable: false, defaultContent: "" }, // <-- Acciones
      ],
      buttons: [
        {
          extend: "colvisGroup",
      ...
      initComplete: function () {
        console.log("✅ DataTable initComplete llamado");
